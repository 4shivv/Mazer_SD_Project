...
import {
  deleteDocumentForInstructor,
  DocumentServiceError,
  listDocumentsForInstructor,
  retrieveRelevantChunks,
  uploadDocumentForInstructor,
...
documentsRouter.get("/", requireAuth, requireInstructor, async (req, res) => {
  try {
...
documentsRouter.post("/upload", requireAuth, requireInstructor, async (req, res) => {
  try {
    ...
    const result = await uploadDocumentForInstructor({
      instructorId: req.user!.id,
...
documentsRouter.delete("/:id", requireAuth, requireInstructor, async (req, res) => {
  try {
    ...
    const result = await deleteDocumentForInstructor({
      instructorId: req.user!.id,
      documentId,
    });
    return res.json(result);
...
documentsRouter.get("/query", requireAuth, requireInstructor, async (req, res) => {
